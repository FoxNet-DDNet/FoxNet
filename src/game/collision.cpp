...
{
	CColQuadData QuadDataCopy;
	static_cast<CQuadData &>(QuadDataCopy) = QuadData;
	QuadDataCopy.m_TileIndex = TileIndex;

	m_vQuads.push_back(QuadDataCopy);
	if(QuadDataCopy.m_Animated)
