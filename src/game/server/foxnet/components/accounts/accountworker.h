#ifndef GAME_SERVER_FOXNET_COMPONENTS_ACCOUNTWORKER_H
#define GAME_SERVER_FOXNET_COMPONENTS_ACCOUNTWORKER_H
...
#endif // GAME_SERVER_FOXNET_COMPONENTS_ACCOUNTWORKER_H