...
public:
	...
	void CreateExplosion(vec2 Pos, int Owner, int Weapon, bool NoDamage, int ActivatedTeam, int MultiMapIdx, CClientMask Mask = CClientMask().set());
...
private:
	...
	static void ConSetTuneOverride(IConsole::IResult *pResult, void *pUserData);
