...
// Multimap
MACRO_CONFIG_INT(SvMultimap, sv_multimaps, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether to enable multimap functionality")
...
// Logging
MACRO_CONFIG_INT(SvLogWhispers, sv_log_whispers, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether to enable logging of whispers")
MACRO_CONFIG_INT(SvLogExtra, sv_log_extra, 0, 0, 2, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether to enable extra logging")
