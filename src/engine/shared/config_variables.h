...
// debug
// FoxNet: replaced by add_dummies
...
MACRO_CONFIG_INT(SvPreauthTimeout, sv_preauth_timeout, 10, 0, 60, CFGFLAG_SERVER, "Time in seconds for clients to complete pre-authentication (0 for no limit)")
